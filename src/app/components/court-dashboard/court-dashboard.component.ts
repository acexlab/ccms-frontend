...
@Component({
  ...
  template: `
    <!-- TopNavBar -->
    <header class="flex justify-between items-center w-full px-8 sticky top-0 z-50 bg-white border-b border-gray-200 h-16 shadow-sm">
      <div class="flex items-center gap-4">
        <span class="font-bold text-2xl text-[#0b2265]">CCMS</span>
    ...
    <div class="flex bg-[#f8fafc] min-h-[calc(100vh-64px)]">
      <!-- SideNavBar -->
      <aside class="w-[280px] bg-white border-r border-gray-200 flex flex-col pt-8 pb-6 sticky top-16 h-[calc(100vh-64px)]">
        <div class="px-6 mb-8 flex items-center gap-3">
          <div class="w-10 h-10 rounded-lg bg-[#0b2265] flex items-center justify-center shadow-sm">
        ...
        <nav class="flex-1 space-y-1.5">
          <a class="flex items-center gap-3 py-3 px-6 bg-[#dbeafe] text-[#1e40af] font-semibold rounded-lg mx-3 transition-all cursor-pointer" routerLink="/court/dashboard">
            <span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">dashboard</span>
            <span class="text-sm">Dashboard</span>
          </a>
          <a class="flex items-center gap-3 py-3 px-6 text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded-lg mx-3 transition-all cursor-pointer" routerLink="/court/create-case">
      ...
      <main class="flex-1 p-8 overflow-y-auto">
        <div class="max-w-6xl mx-auto space-y-8">
          ...
          <div class="flex justify-between items-start">
            <div>
              <h1 class="text-2xl font-bold text-gray-900 mb-1">Officer Overview</h1>
              <p class="text-sm text-gray-500">Welcome back. You have {{ countStatus('Pending') }} cases requiring immediate action.</p>
            </div>
            <button routerLink="/court/create-case" class="px-5 py-2.5 bg-[#0b2265] text-white text-sm font-semibold rounded-lg hover:bg-[#081a4d] transition-all flex items-center gap-2 shadow-sm">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-4 relative shadow-sm hover:shadow-md transition-shadow">
              <div class="flex justify-between items-start">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
              ...
              <div class="flex flex-wrap items-center gap-3">
                ...
                <div class="relative w-64">
                  ...
                  <input type="text" [(ngModel)]="searchQuery" (input)="onSearchOrFilterChange()" placeholder="Search cases (No., Name, Type)..." class="w-full bg-[#f8fafc] border border-gray-200 rounded-lg pl-9 pr-3 py-1.5 text-xs text-gray-800 placeholder-gray-400 focus:outline-none focus:border-[#0b2265] focus:ring-1 focus:ring-[#0b2265]"/>
                </div>

                <!-- Status Filter Select -->
                <div class="relative">
                  <select [(ngModel)]="selectedStatus" (change)="onSearchOrFilterChange()" class="appearance-none bg-[#f8fafc] border border-gray-200 rounded-lg pl-3 pr-8 py-1.5 text-xs text-gray-700 font-semibold focus:outline-none focus:border-[#0b2265] focus:ring-1 focus:ring-[#0b2265] cursor-pointer">
